...
public class ConfigActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public static final String UPLOAD_DATA_KEY = "true";//"upload_data_preference";
    public static final String UPLOAD_URL_KEY = "https://myshopmanager.com/webhooks/obd/upload";//"upload_url_preference";
    //bluetooth
